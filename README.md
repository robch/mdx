...
EXAMPLES
  ...
  EXAMPLE 5: Run a command with environment variables
    ...
    mdx run -e NAME=John -e GREETING=Hello "echo $GREETING, $NAME!"

  EXAMPLE 6: Run a script with environment variables

    mdx run --bash -e API_KEY=abc123 -e API_URL=https://api.example.com "curl -H 'Authorization: Bearer $API_KEY' $API_URL"
